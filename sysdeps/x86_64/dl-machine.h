...
# endif
      /*xiaojin relocate -2.5*/struct link_map *sym_map = RESOLVE_MAP (map, scope, &sym, version,
					      r_type);
...
#  endif
	  ...
	  value = sym->st_size;
# endif
	  /* Fall through. */ /*xiaojin relocate -1.1 *reloc_addr 是关键*/
	case R_X86_64_GLOB_DAT:
	case R_X86_64_JUMP_SLOT:/*xiaojin relocate -2.6 elf_machine_rela*/
...
//~ xiaojin elf_machine_rela_relative 重定位
static inline void
