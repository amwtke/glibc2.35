...
/* This macro is used as a callback from the ELF_DYNAMIC_RELOCATE code.  *//*xiaojin relocate -3 搜索符号的地方*/
...
# define consider_symbind 0
...

  {
    ...
    /*xiaojin relocate -1*/ELF_DYNAMIC_RELOCATE (l, scope, lazy, consider_profiling, skip_ifunc);
