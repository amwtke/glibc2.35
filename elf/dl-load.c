...
#endif
struct link_map *
 /*xiaojin load-so -4*/_dl_map_object_from_fd (const char *name, const char *origname, int fd,
...
# endif
 ...
 no_file:
  ...
  /*xiaojin load-so -3*/return _dl_map_object_from_fd (name, origname, fd, &fb, realname, loader,
